...
public class PageFlowView extends LinearLayout {
    ...
    public PageFlowView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PageFlowView);
        try {
            indicatorMargin = a.getInt(R.styleable.PageFlowView_indicatorMargin, 0);
            maxRows = a.getInt(R.styleable.PageFlowView_maxRows, 0);
            maxPages = a.getInt(R.styleable.PageFlowView_maxPages, 0);
        } finally {
            a.recycle();
        }
        init();
    ...
    public PageFlowView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PageFlowView, defStyle, 0);
        try {
            indicatorMargin = a.getInt(R.styleable.PageFlowView_indicatorMargin, 0);
            maxRows = a.getInt(R.styleable.PageFlowView_maxRows, 0);
            maxPages = a.getInt(R.styleable.PageFlowView_maxPages, 0);
